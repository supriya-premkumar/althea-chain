...
import (
	...
	"github.com/althea-net/althea-chain/x/gravity/types"
...
func CreateTestEnv(t *testing.T) TestInput {
	...
	ms.MountStoreWithDB(lockupKey, sdk.StoreTypeIAVL, db)
	...
	k := NewKeeper(marshaler, lockupKey, getSubspace(paramsKeeper, types.DefaultParamspace))
